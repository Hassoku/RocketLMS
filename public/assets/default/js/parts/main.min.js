(function ($) {
  ...
  * */
  ...
  $('body').on('click', '.delete-action', function (e) {
    ...
    var html = '<div class="">\n' + '    <p class="">Delete</p>\n' + '    <div class="mt-30 d-flex align-items-center justify-content-center">\n' + '        <button type="button" id="swlDelete" data-href="' + href + '" class="btn btn-sm btn-primary">Data Deleted</button>\n' + '        <button type="button" class="btn btn-sm btn-danger ml-10 close-swl">Save</button>\n' + '    </div>\n' + '</div>';
    Swal.fire({
      title:'DataDeleted',
      html: html,
      icon: 'warning',
