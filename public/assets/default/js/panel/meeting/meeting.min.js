  ...
  $('body').on('click', '#meetingSettingFormSubmit', function (e) {
    ...
    $.post(action, data, function (result) {
      ...
      if (result && result.code === 200) {
        Swal.fire({
          icon: 'success',
          html: '<h3 class="font-20 text-center text-dark-blue py-25">Time Updated</h3>',
          showConfirmButton: false,
          width: '25rem'
        });
        setTimeout(function () {
